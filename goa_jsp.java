 ...
 * Generated at: 2025-02-21 23:48:48 UTC
...
public final class goa_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Goa Page</title>\r\n");
      ...
      out.write("   <link rel=\"stylesheet\" href=\"goa.jsp\">\r\n");
      ...
      out.write("            <h1>WECOME TO GOA</h1>\r\n");
      out.write("            \r\n");
      out.write("        </div>\r\n");
      out.write("        <img src=\"g1.jpg\" class=\"img1\" alt=\"image\">\r\n");
      out.write("    </div>\r\n");
...
for(i=0;i<n;i++){
	if(tlist.get(i).getCity().equals("Goa") && tlist.get(i).getCategory().equals("hotel")){
...
out.print("<ul class='cards'>");
for(i=0;i<n;i++){
	if(tlist.get(i).getCity().equals("Goa") && tlist.get(i).getCategory().equals("car")){
	out.print("<li class='card'>");
	out.print("<div>");
	out.print("<h3 class='card-title'>"+tlist.get(i).getPlace()+"</h3>");
	out.print("<div class='card-content'>");
...
out.print("<ul class='cards'>");
for(i=0;i<n;i++){
	if(tlist.get(i).getCity().equals("Goa") && tlist.get(i).getCategory().equals("place")){
	out.print("<li class='card'>");
	out.print("<div>");
	out.print("<h3 class='card-title'>"+tlist.get(i).getPlace()+"</h3>");
	out.print("<div class='card-content'>");
...
out.print("<ul class='cards'>");
for(i=0;i<n;i++){
	if(tlist.get(i).getCity().equals("Goa") && tlist.get(i).getCategory().equals("medicine")){
	out.print("<li class='card'>");
	out.print("<div>");
	out.print("<h3 class='card-title'>"+tlist.get(i).getPlace()+"</h3>");
	out.print("<div class='card-content'>");
...
out.print("<ul class='cards'>");
for(i=0;i<n;i++){
	if(tlist.get(i).getCity().equals("Goa") && tlist.get(i).getCategory().equals("bus")){
	out.print("<li class='card'>");
	out.print("<div>");
	out.print("<h3 class='card-title'>"+tlist.get(i).getPlace()+"</h3>");
	out.print("<div class='card-content'>");
...
out.print("<ul class='cards'>");
for(i=0;i<n;i++){
	if(tlist.get(i).getCity().equals("Goa") && tlist.get(i).getCategory().equals("rail")){
	out.print("<li class='card'>");
	out.print("<div>");
	out.print("<h3 class='card-title'>"+tlist.get(i).getPlace()+"</h3>");
	out.print("<div class='card-content'>");
